                 ...
                 >
                   ...
                   >
                     ...
                     <div className="mt-4 space-y-3">
                      <BarRow label={t("bars.average")} percent={avgPercent} accent />
                           ...
                           <table className="w-full text-sm">
                             <thead>
                               <tr className="text-left text-xs uppercase tracking-[0.3em] text-[#7a5b45]">
                                <th className="py-2 pr-4">{t("table.rating")}</th>
                                <th className="py-2 pr-4">{t("table.visitor")}</th>
                                <th className="py-2 pr-4">{t("table.userAgent")}</th>
